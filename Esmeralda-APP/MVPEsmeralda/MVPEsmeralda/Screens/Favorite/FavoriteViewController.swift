...
class FavoriteViewController: UIViewController, ViewControllerProtocol {
    ...
    */
    ...
    let collectionDelegate = MVPFavoriteDelegate()
    let collectionDataSource = MVPFavoritedataSource()
