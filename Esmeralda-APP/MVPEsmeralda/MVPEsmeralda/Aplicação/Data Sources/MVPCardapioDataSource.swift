...
class MVPCardapioDataSource: NSObject, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MVPCardapioCell.identifier, for: indexPath) as? MVPCardapioCell else {
